            ...
            >
                ...
                <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity shrink-0">
                    ...
                    {canOutdent && (
                        ...
                        >
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 19l-7-7 7-M19 19l-7-7 7-7"/>
                            </svg>
                        </button>
                    )}
                    <button
                    ...
                    >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862.a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10Va1 1 0 001-1-1h-4a1 1 0 00-1 1v3M4 7h16"/>
                        </svg>
                    </button>
                </div>
            </div>
                ...
                {list.items.length === 0 ? (
                    <div className="text-center py-16 animate-fade-in">
                        <svg className="w-24 h-24 mx-auto mb-4 text-neutral-200 dark:text-neutral-700" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={0.8}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293707V19a2 2 0 01-2 2z"/>
                        </svg>
